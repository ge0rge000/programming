          ...
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href=""><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Dashboard</span></a>
              <ul class="menu-content">
                <li ><a class="menu-item" href="{{route("show_category")}}" data-i18n="nav.dash.ecommerce">Show Category</a>
                </li>
                <li ><a class="menu-item" href="{{route("add_category")}}" data-i18n="nav.dash.ecommerce">add category</a>
                </li>
                <li ><a class="menu-item" href="{{route("show_category")}}" data-i18n="nav.dash.ecommerce">show category</a>
                </li>
                <li ><a class="menu-item" href="{{route("typeadd")}}" data-i18n="nav.dash.ecommerce">add Type</a>
                </li>
