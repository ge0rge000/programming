   ...
   <div class="col-md-12">
    <div class="card" style="height: 970.688px;">
        ...
        <div class="card-content collapse show">
            <div class="card-body">
                <form class="form" wire:submit="add_type" enctype="multipart/form-data">
                    <div class="form-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <fieldset class="form-group position-relative">
                                        <select class="form-control" id="DefaultSelect" wire:model="categeory_service">
                                            <option>Default select options</option>
